        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          ...
          ease: "easeOut"
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-white/95 mb-8 sm:mb-12 max-w-4xl mx-auto leading-relaxed px-4 drop-shadow-md">
              ...
              <span className="font-semibold bg-gradient-to-r from-yellow-300 via-orange-300 to-red-300 bg-clip-text text-transparent"> SARFAESI, DRT, IBC & Financial Restructuring</span>
            </p>
